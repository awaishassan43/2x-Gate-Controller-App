                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Selector<DeviceController, double>(
                              selector: (context, controller) => controller.devices[widget.deviceID]!.deviceData.state.payload.Temp,
                            ...
                            Selector<DeviceController, double>(
                              selector: (context, controller) => controller.devices[widget.deviceID]!.deviceData.state.payload.humidity,
                        ...
                        Selector<DeviceController, Tuple2<DeviceSettings, DeviceData>>(
